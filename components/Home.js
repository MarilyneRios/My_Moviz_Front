...
//--- hook d’effet, faites une requête vers le backend webservice afin de remplacer le tableau d’objet moviesData par les données renvoyées par l’API---
  ...
  //--setMoviesData(data.movies);=> movies = clé qui correspond à index.js: res.json({ movies: data.results }) != différent de setMoviesData(data);
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
//---L’overview est parfois très long => Tronquez le pour que sa longueur ne dépasse pas 250 caractères et qu’il finisse par “...”---
//--- ajustez le style de vos cards---
//---------------------------------------------------------------------------------------------------------------------------------------------------------
